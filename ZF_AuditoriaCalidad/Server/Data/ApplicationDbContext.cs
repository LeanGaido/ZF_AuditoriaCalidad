...
namespace ZF_AuditoriaCalidad.Server.Data
{
    public class ApplicationDbContext : ApiAuthorizationDbContext<ApplicationUser>
    {
        ...
        //       new Proceso { ID = 1, AreaID = 1, Descripcion = "Proceso 1 del Area de Produccion 1" },
        //       new Proceso { ID = 2, AreaID = 2, Descripcion = "Proceso 2 del Area de Produccion 2" },
        //       new Proceso { ID = 3, AreaID = 3, Descripcion = "Proceso 3 del Area de Produccion 3" },
        //       new Proceso { ID = 4, AreaID = 4, Descripcion = "Proceso 4 del Area de Produccion 4" },
        //       new Proceso { ID = 5, AreaID = 5, Descripcion = "Proceso 5 del Area de Produccion 5" },
        //       new Proceso { ID = 6, AreaID = 6, Descripcion = "Proceso 6 del Area de Produccion 6" },
        //       new Proceso { ID = 7, AreaID = 7, Descripcion = "Proceso 7 del Area de Produccion 7" }
        //   );

        //    modelBuilder.Entity<Maquina>().HasData(
        //        new Maquina { ID = 1, ProcesoID = 1, Descripcion = "Maquina Nro 1 del Proceso Nro 1" },
        //        new Maquina { ID = 2, ProcesoID = 1, Descripcion = "Maquina Nro 2 del Proceso Nro 1" },
        //        new Maquina { ID = 3, ProcesoID = 1, Descripcion = "Maquina Nro 3 del Proceso Nro 1" },
        //        new Maquina { ID = 4, ProcesoID = 1, Descripcion = "Maquina Nro 4 del Proceso Nro 1" },
        //        new Maquina { ID = 5, ProcesoID = 1, Descripcion = "Maquina Nro 5 del Proceso Nro 1" },
        //        new Maquina { ID = 6, ProcesoID = 2, Descripcion = "Maquina Nro 6 del Proceso Nro 2" },
        //        new Maquina { ID = 7, ProcesoID = 2, Descripcion = "Maquina Nro 7 del Proceso Nro 2" },
        //        new Maquina { ID = 8, ProcesoID = 2, Descripcion = "Maquina Nro 8 del Proceso Nro 2" },
        //        new Maquina { ID = 9, ProcesoID = 2, Descripcion = "Maquina Nro 9 del Proceso Nro 2" },
        //        new Maquina { ID = 10, ProcesoID = 2, Descripcion = "Maquina Nro 10 del Proceso Nro 2" },
        //        new Maquina { ID = 11, ProcesoID = 3, Descripcion = "Maquina Nro 11 del Proceso Nro 3" },
        //        new Maquina { ID = 12, ProcesoID = 3, Descripcion = "Maquina Nro 12 del Proceso Nro 3" },
        //        new Maquina { ID = 13, ProcesoID = 3, Descripcion = "Maquina Nro 13 del Proceso Nro 3" },
        //        new Maquina { ID = 14, ProcesoID = 4, Descripcion = "Maquina Nro 14 del Proceso Nro 4" },
        //        new Maquina { ID = 15, ProcesoID = 4, Descripcion = "Maquina Nro 15 del Proceso Nro 4" },
        //        new Maquina { ID = 16, ProcesoID = 4, Descripcion = "Maquina Nro 16 del Proceso Nro 4" },
        //        new Maquina { ID = 17, ProcesoID = 4, Descripcion = "Maquina Nro 17 del Proceso Nro 4" },
        //        new Maquina { ID = 18, ProcesoID = 4, Descripcion = "Maquina Nro 18 del Proceso Nro 4" },
        //        new Maquina { ID = 19, ProcesoID = 4, Descripcion = "Maquina Nro 19 del Proceso Nro 4" },
        //        new Maquina { ID = 20, ProcesoID = 5, Descripcion = "Maquina Nro 20 del Proceso Nro 5" },
        //        new Maquina { ID = 21, ProcesoID = 5, Descripcion = "Maquina Nro 21 del Proceso Nro 5" }
        //    );
